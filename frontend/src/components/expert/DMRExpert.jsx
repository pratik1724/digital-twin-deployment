  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="default" className="dmr-expert-trigger">DMR IntelliAssist</Button>
      </DialogTrigger>
      <DialogContent className="dmr-expert-modal">
        <div className="dmr-expert-header">
          <div className="dmr-expert-title-section">
            <h2 className="dmr-expert-title">DMR IntelliAssist</h2>
            ...
            {answer && (
              <div className="dmr-expert-message assistant-message">
                <div className="message-header">
                  ...
                  <span className="assistant-name">DMR IntelliAssist</span>
                </div>
                <div className="message-content">
